...
def je_prvocislo(cislo):
    ...
    if zbytek_deleni == 0:
        return False, delitel  # pokud delitelne 2, neni prvocislo
    ...
    if zbytek_deleni == 0:
        return False, delitel - 2  # nalezen delitel, neni prvocislo
    else:
        delitel = None
        return True, delitel  # nenalezen zadny delitel, je prvocislo
...
if __name__ == "__main__":
    ...
    print()  # prazdna radka pro prehlednost vypisu
    je_prvocis, delitel = je_prvocislo(cislo_x)
    if je_prvocis:
        print("{} je prvocislo.".format(cislo_x))
    else:
        print("{} neni prvocislo. Je delitelne {}.".format(cislo_x, delitel))
    print()  # prazdna radka pro prehlednost vypisu
